 ...
 */
class FW_Theme_Featured_Content {
	 ...
	 *
	 * @see FW_Theme_Featured_Content::init()
	 *
	 * @static
	 * @access public
	 * @var int
	 ...
	 *
	 * @see FW_Theme_Featured_Content::validate_settings().
	 *
	 * @static
	 * @access public
	 */
	 ...
	 * the transient is deleted by FW_Theme_Featured_Content::validate_settings().
	 *
	 ...
	 *
	 * @uses FW_Theme_Featured_Content::get_setting()
	 */
	...
	public static function customize_register( $wp_customize ) {
		...
		$wp_customize->add_setting( 'featured-content[tag-name]', array(
			'default'              => _x( 'featured', 'featured content default tag slug', 'unyson' ),
			'type'                 => 'option',
		...
		$wp_customize->add_control( 'featured-content[tag-name]', array(
			'label'    => __( 'Tag Name', 'unyson' ),
			'section'  => 'featured_content',
			'priority' => 20,
		) );
		$wp_customize->add_control( 'featured-content[hide-tag]', array(
			'label'    => __( 'Don&rsquo;t display tag on front end.', 'unyson' ),
			'section'  => 'featured_content',
			'type'     => 'checkbox',
			'priority' => 30,
		) );
	...
	public static function enqueue_scripts() {
		wp_enqueue_script(
			'fw-theme-featured-content-suggest',
			get_template_directory_uri() . '/js/featured-content-admin.js',
	...
	public static function get_setting( $key = 'all' ) {
		...
		$defaults = array(
			'hide-tag' => 1,
			'tag-id'   => 0,
			'tag-name' => _x( 'featured', 'featured content default tag slug', 'unyson' ),
		);
	 ...
	 * delete the transient set in FW_Theme_Featured_Content::get_featured_content().
	 *
	 * @static
	 * @access public
	 *
...
} // FW_Theme_Featured_Content

FW_Theme_Featured_Content::setup();
